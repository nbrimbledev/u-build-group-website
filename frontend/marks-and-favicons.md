...
| --- | --- | --- |
| [`ubuild-group-mark.png`](../public/brand/ubuild-group-mark.png) | U Build Group U in the header and footer, favicon, web-app manifest, and organization metadata | Transparent PNG, 1000 × 1000 |
